...
MODELS_WITH_HYPERPARAMETERS = {
    "Ridge": {
        "alpha": [0.1, 1.0, 10.0, 100.0]  # Standard range around default
    },
    "Lasso": {
        "alpha": [0.01, 0.1, 1.0, 10.0]  # Standard range around default
    },
    "ElasticNet": {
        "alpha": [0.01, 0.1, 1.0, 10.0],  # Standard range around default
...
HYPERPARAMETER_SPACES = {
    "Ridge": {
        "alpha": ["loguniform", 0.1, 100.0]  # Standard range around default (1.0)
    },
    "Lasso": {
        "alpha": ["loguniform", 0.01, 10.0]  # Standard range around default (1.0)
    },
    "ElasticNet": {
        "alpha": ["loguniform", 0.01, 10.0],  # Standard range around default (1.0)
        "l1_ratio": ["uniform", 0.1, 0.9]  # Exclude pure L1/L2 to avoid numerical issues
    },
    "RandomForest": {
...
MODELS_WITHOUT_HYPERPARAMETERS = [
    ...
    "KNN",              # Can use default parameters
...
TABPFNICL_CONTEXT_SIZE = 50  # Increased context size
...
OPTUNA_N_TRIALS = 5  # Further reduced for faster completion
