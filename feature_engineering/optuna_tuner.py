    ...
    if config is None:
        if model_type == "regression":
            ...
            try:
                ...
                import regression.config_regression as config
        else:
        ...
        if model_type == "regression":
            ...
            try:
                if model_name == "Ridge":
                    ...
                    sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
                    try:
                        from regression.models.regression_models import TabPFNICLWrapper
                    except ImportError:
                        # Try alternative path if the first one doesn't work
                        sys.path.append(os.path.dirname(os.path.abspath(__file__)))
                        from regression.models.regression_models import TabPFNICLWrapper
                    ...
                    sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
                    try:
                        from regression.models.regression_models import GPT2ICLRegressorWrapper
                    except ImportError:
                        #Try alternative path if the first one doesn't work
                        sys.path.append(os.path.dirname(os.path.abspath(__file__)))
                        from regression.models.regression_models import GPT2ICLRegressorWrapper
